...
insert into user_tb (user_name, user_password, user_email, created_at) values ('ssar', '1234', 'ssar@email.com', now());
insert into user_tb (user_name, user_password, user_email, created_at) values ('cos', '1234', 'cos@email.com', now());
